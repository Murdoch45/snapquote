    ...
    <main className={`${manrope.className} min-h-screen bg-white text-slate-900`}>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16 sm:px-8">
        ...
        <div className="mt-10 space-y-10 text-[15px] leading-8 text-slate-700">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-slate-900">4. Credits and Billing</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-slate-900">6. AI-Generated Estimates</h2>
            <p>
