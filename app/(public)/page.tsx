  ...
  return (
    <main className={manrope.className}>
      <div className="min-h-screen overflow-x-hidden bg-[#101320] text-foreground">
        ...
        <section className="min-h-screen bg-muted py-24">
          <div className="mx-auto max-w-7xl px-6 sm:px-8">
            <div className="grid grid-cols-1 items-center gap-20 md:grid-cols-2">
              <div className="space-y-8">
                <div className="inline-block rounded-full bg-[#b4c5ff]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-primary">
                  Smart Estimating
                </div>
                <h2 className="text-5xl font-extrabold leading-tight tracking-tight text-foreground">
                  Focus on jobs that <br />
                  <span className="text-primary">pay the bills.</span>
                </h2>
              ...
              <div className="relative">
                <div className="rounded-[14px] border border-border bg-card p-8 shadow-xl">
                  ...
                  <div className="rounded-lg bg-slate-50 p-4">
                    <div className="font-bold text-foreground">Estimated Revenue</div>
                    <div className="text-2xl font-black text-primary">$12,450.00</div>
                  </div>
                </div>
                <div className="absolute -bottom-10 -right-10 -z-10 h-40 w-40 rounded-full bg-primary/5 blur-3xl" />
              </div>
            </div>

            <div className="mt-40 grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="group rounded-[14px] border border-slate-100 bg-card p-10 shadow-[0_10px_30px_rgba(0,0,0,0.05)] transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="group rounded-[14px] border border-slate-100 bg-card p-10 shadow-[0_10px_30px_rgba(0,0,0,0.05)] transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="mb-4 text-xl font-bold text-foreground">60-Second Lead Capture</h3>
                <p className="leading-relaxed text-muted-foreground">
              ...
              <div className="group rounded-[14px] border border-slate-100 bg-card p-10 shadow-[0_10px_30px_rgba(0,0,0,0.05)] transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="mb-4 text-xl font-bold text-foreground">Profit Filtering</h3>
                <p className="leading-relaxed text-muted-foreground">
        ...
        <section className="relative overflow-hidden bg-[#101320] py-32">
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center sm:px-8">
            ...
            <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
              <Button asChild className="h-auto rounded-full bg-primary px-10 py-5 text-xl font-bold text-white shadow-lg hover:scale-105 hover:bg-primary/90">
